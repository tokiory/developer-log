export default defineI18nLocale(async () => {
  return {
    ...
    error: {
      ...
      description:
        "Команда котов-разработчиков уже работает над тем чтобы устранить данную ошибку.",
    ...
    projects: {
      ...
      zedgruvbox: {
        short: "Тема для редактора Zed",
        long: {
          1: "Я достаточно долго время пользовался темой Gruvbox Material, поэтому решил перенести ее на Zed. В данном проекте я использовал Go для того чтобы парсить схему редактора и подставлять нужные цвета",
        },
      },
      gosha: {
    ...
    page: {
      ...
      posts: {
        ...
        stubTryAgain:
          "Проверьте поле поиска на опечатки или напишите другой запрос.",
      },
      post: {
        neighbours: {
