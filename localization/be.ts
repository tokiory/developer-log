export default defineI18nLocale(async () => {
  return {
    ...
    cookie: {
      title:
        "Мы выкарыстоўваем кукі. Гэта дазваляе нам аналізаваць узаемадзеянне наведвальнікаў з сайтам і рабіць яго лепш.",
      description:
        "Працягваючы карыстанне сайтам, вы згаджаецеся з выкарыстаннем файлаў cookie.",
    },
    error: {
      title: "Адбылася памылка!",
      description:
        "Каманда катоў-распрацоўшчыкаў ужо працуе над тым, каб устараніць дадзеную памылку.",
    ...
    projects: {
      ...
      zedgruvbox: {
        short: "Тэма для рэдактара Zed",
        long: {
          1: "Я дастаткова доўга час карыстаўся тэмай Gruvbox Material, таму вырашыў перанесці яе на Zed. ",
        },
      },
      interquesty: {
      ...
      termprofile: {
        short: "Партфоліа ў выглядзе тэрмінала",
        long: {
          1: "Term Portfolio ― маленькі праект, які рэалізуе інтэрфейс тэрмінала ў браўзэры. У дадзеным праекце я затлумляўся з ASCII-малюнкамі і цікавымі фічамі.",
        },
      },
      gosha: {
        short: "Кансольны менеджэр задач",
        long: {
          1: "Gosha ― простае кансольнае дадатак на Go, якое я зрабіў для таго каб хутка рэдагаваць свой бягучы план на дзень, а таксама для таго каб вывучыць асновы Go.",
        },
      },
    },
    hardware: {
    ...
    page: {
      ...
      projects: {
        ...
        chooseDescription:
          "Для таго каб працягнуць, вам трэба выбраць адзін з праектаў са спісу.",
      },
      home: {
        tabTitle: "Хатняя",
        title: "Лог распрацоўніка",
      ...
      posts: {
        ...
        stubTryAgain:
          "Праверце поле пошуку на памылкі друку або напішыце іншы запыт.",
      },
      author: {
        tabTitle: "Аўтар",
        hello: "Прывітанне!",
        ...
        pursuit:
          "Я імкнуся працягваць расці як фронтэнд-распрацоўшчык, уносячы свой уклад у развіццё сучасных і інавацыйных вэб-прыкладанняў. Я актыўна вяду блог, а таксама пішу на VC, Habr і ў Telegram.",
